      ...
      if (item.kind === "text") {
        ...
        for (let i = 0; i < item.cells.length; ++i) {
          ...
          if (firstLine) {
            ...
            if (d > 0) {
              ...
              startLineY += dy * env.unitSize * 0.4;
              startLineX += dx * env.unitSize * 0.4;
            }
            firstLine = false;
          }
        ...
        if (item.cells.length >= 1) {
          ...
          if (item.cells.length >= 2) {
            ...
            const secondLastX = env.offsetX + env.unitSize * (secondLast.x / 2);
          ...
          elements.push(
            <line
              ...
              x1={lastX}
              y1={lastY}
              x2={lastX - dx * env.unitSize * scale + dy * env.unitSize * scale}
              y2={lastY - dy * env.unitSize * scale - dx * env.unitSize * scale}
              stroke={color}
              strokeWidth={3}
              strokeLinecap="round"
            />
